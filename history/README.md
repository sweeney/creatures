...
Contemporary material *about* Creatures 1.0 — press and web captures. Nothing
here is read by any code; the program itself and everything unpacked from it
are in [`../original/`](../original/).

| item | what it is |
|---|---|
| `Rabbits are blue, foxes red _ Tes Magazine` | *Times Educational Supplement* review of the program, html + pdf |
| `fssc.demon.co.uk` | Future Skill Software's own website, captured — html, pdf and assets |
